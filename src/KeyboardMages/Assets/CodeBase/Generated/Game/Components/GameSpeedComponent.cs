...
public partial class GameEntity {
    ...
    public CodeBase.Gameplay.Features.Movement.Speed speed { get { return (CodeBase.Gameplay.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (CodeBase.Gameplay.Features.Movement.Speed)CreateComponent(index, typeof(CodeBase.Gameplay.Features.Movement.Speed));
