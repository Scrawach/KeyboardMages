...
public partial class GameEntity {
    ...
    public CodeBase.Common.ViewPrefab viewPrefab { get { return (CodeBase.Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public CodeBase.Infrastructure.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(CodeBase.Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (CodeBase.Common.ViewPrefab)CreateComponent(index, typeof(CodeBase.Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(CodeBase.Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (CodeBase.Common.ViewPrefab)CreateComponent(index, typeof(CodeBase.Common.ViewPrefab));
        component.Value = newValue;
